...
public class Utils {
    ...
    public static RoomDTO mapRoomEntityToRoomDTO(Room room) {
        ...
        roomDTO.setRoomPrice(String.valueOf(room.getRoomPrice())); //change ValueOf
    ...
    public static RoomDTO mapRoomEntityToRoomDTOPlusBookings(Room room) {
        ...
        roomDTO.setId(room.getId());
        roomDTO.setRoomType(room.getRoomType());
        roomDTO.setRoomPrice(String.valueOf(room.getRoomPrice())); //String.valueOf
        roomDTO.setRoomPhotoUrl(room.getRoomPhotoUrl());
        roomDTO.setRoomDescription(room.getRoomDescription());
    ...
    public static BookingDTO mapBookingEntityToBookingDTOPlusBookedRooms(Booking booking, boolean mapUser) {
        ...
        if (booking.getRoom() != null) {
            ...
            roomDTO.setRoomPrice(String.valueOf(booking.getRoom().getRoomPrice())); //String.valueOf
